...
const CPCStudymaterial = () => {
    return (
        <>
            <Row className='cpc-study-material align-items-center'>
                <Col lg={1}></Col>
                <Col lg={5}>
                    <div><h2 className='text-left mt-3'>CPC Study Materials</h2></div>
                    <ul style={{ listStyleType: 'none', padding: 0 }}>
                        ...
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                            CPC Sample Exam Preparations Question Papers - Included
                        </li>
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                        ...
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                            Tips to Clear CPC Exam in Single attempt by expert advice.
                        </li>
                    </ul>
                </Col>
                <Col lg={1}></Col>
...
export default CPCStudymaterial;
