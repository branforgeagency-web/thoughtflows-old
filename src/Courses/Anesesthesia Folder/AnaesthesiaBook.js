...
const features = [
    { 
        icon: classroom, 
        title: "CPT Professional Edition (Current Year)" 
    },
    { 
        icon: studyMaterial, 
        title: "ICD-10-CM Coding Manual (Current Year)" 
    },
    { 
        icon: learning, 
        title: "HCPCS Level II Manual (Current Year)" 
    },
    { 
        icon: training, 
        title: "AAPC’s CANPC™ (Certified Anesthesia and Pain Management Coder) Study Guide" 
    }
];



const AnaesthesiaBook = () => {
    return (
        <div className="bg-gradient-to-br from-[#0e929f] to-[#4da9b3] py-16 px-5 text-center text-white">
            ...
            <p className="text-gray-100 mt-6 text-center">
                The following study materials are essential for our anesthesia coding training:
            </p>
...
export default AnaesthesiaBook;
