    ...
    const courseSections =[
        {
            ...
            paragraph: "Our live training sessions ensure a structured and engaging learning experience, featuring:",
            points: [
                "PowerPoint Presentations explaining key concepts in risk adjustment and HCC coding.",
                "Video Tutorials to reinforce coding best practices and compliance regulations.",
                "Interactive Q&A Sessions for real-time doubt clarification and personalized guidance."
            ]
        },
        {
            heading: "Practice Exams",
            paragraph: "We provide a systematic approach to mastering HCC coding through:",
            points: [
                "Chapter-wise Assessments to strengthen understanding of each topic.",
                "Mock HCC Coding Exams simulating real-world coding scenarios.",
                "Detailed Feedback & Performance Tracking to identify areas for improvement."
            ]
        },
        {
            heading: "Self-Study Materials",
            paragraph: "Our extensive resources support independent learning, including:",
            points: [
                "HCC Coding & Risk Adjustment Guides covering core concepts and CMS regulations.",
                "Chapter-wise Study Plans to streamline and optimize exam preparation."
            ]
        },
        {
            heading: "Interview Preparation",
            paragraph: "Beyond training, we equip learners with essential career-building skills:",
            points: [
                "Resume Enhancement: Expert guidance to craft an industry-relevant resume.",
                "Mock Interviews: Practice sessions to refine communication and problem-solving skills.",
                "Job Placement Support: Assistance in connecting with healthcare employers.",
                "Networking Opportunities to expand professional connections in medical coding and risk adjustment."
            ]
        }
    ];
