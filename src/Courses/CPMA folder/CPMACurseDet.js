    ...
    return (
        <>
            <Row className='cpma-study-material align-items-center'>
                <Col lg={1}></Col>
                <Col lg={5}>
                    <div><h2 className='text-left mt-3'>CPMA Study Materials</h2></div>
                    <ul style={{ listStyleType: 'none', padding: 0 }}>
                        ...
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                            CPMA Sample Exam Preparations Question Papers - Included
                        </li>
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                            CPMA previous years Question paper with rationale and Answers - Included
                        </li>
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                        ...
                        <li>
                            <img src={Arrow} alt="arrow" style={{ width: '15px', marginRight: '10px' }} />
                            Tips to Clear CPMA Exam in Single attempt by expert advice.
                        </li>
                    </ul>
                </Col>
                <Col lg={1}></Col>
