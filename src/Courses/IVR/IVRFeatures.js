    ...
    const courseSections = [
        {
            ...
            paragraph: "Our live training sessions provide a comprehensive and engaging learning experience. Each class includes:",
            points: [
                "PowerPoint Presentations covering key IVR procedures and coding guidelines.",
                "Video Tutorials to reinforce best practices in interventional radiology.",
                "Interactive Q&A Sessions to clarify doubts in real time."
            ]
        },
        {
            heading: "Practice Exams",
            paragraph: "We offer structured assessments to solidify your understanding of IVR concepts:",
            points: [
                "Chapter-wise Assessments to test knowledge of each module.",
                "Mock IVR Exams to simulate real-world scenarios.",
                "Detailed Feedback on test performance to identify areas of improvement.",
                "Progress Tracking to ensure exam readiness."
            ]
        },
        {
            heading: "Self-Study Materials",
            paragraph: "Our comprehensive study resources support independent learning:",
            points: [
                "Interventional Radiology Coding Guidelines for essential compliance knowledge.",
                "Chapter-wise Study Plans to streamline preparation."
            ]
        },
        {
            heading: "Interview Preparation & Job Assistance",
            paragraph: "We help you secure the right job with expert career support:",
            points: [
                "Resume Enhancement to craft a compelling job-ready CV.",
                "Mock Interviews for confidence building and communication skills.",
                "Job Placement Support to connect with potential employers.",
