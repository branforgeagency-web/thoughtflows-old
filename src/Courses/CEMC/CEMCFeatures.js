    ...
    const courseSections =[
        {
            ...
            para: "Our live sessions provide a dynamic and engaging learning environment. Each class utilizes:",
            points: [
                "PowerPoint Presentations to visualize complex coding concepts and industry guidelines.",
                "Video Tutorials that reinforce coding skills and enhance understanding of E/M coding scenarios.",
                "Interactive Q&A sessions to clarify doubts in real-time and ensure personalized attention."
            ]
        },
        {
            heading: "Practice Exams",
            para: "We offer a structured approach to mastering evaluation and management coding through:",
            points: [
                "Chapter-wise Assessments designed to solidify your understanding of each module.",
                "Mock CEMC Exams that replicate the real exam environment, helping you build confidence and improve time management skills.",
                "Detailed Feedback on practice tests to identify strengths and areas for improvement.",
                "Progress Tracking to ensure you are on the path to CEMC certification success."
            ]
        },
        {
            heading: "Self-Study Materials",
            para: "Our comprehensive study resources support independent learning and exam preparation:",
            points: [
                "Code Books: Up-to-date editions of CPT, ICD-10-CM, and HCPCS Level II manuals for E/M coding.",
                "Chapter-wise Study Plans to organize and streamline your preparation effectively."
            ]
        },
        {
            heading: "Interview Preparation",
            para: "Thoughtflows goes beyond training to ensure you secure your first job confidently:",
            points: [
                "Resume Enhancement: Expert guidance on creating a compelling resume tailored to E/M coding roles.",
                ...
                "Placement Assistance to help you land positions offering competitive salary packages in physician offices, hospitals, and healthcare organizations."
            ]
        }
    ];
