...
const cardData = [
    {
        id: 1,
        // image: excellenceimg,
        title: 'Assigning appropriate E/M levels for physician visits',
    ...
    },
    {
        id: 2,
        // image: careeradv,
        title: 'Auditing and analyzing provider documentation for accuracy',
...
const WHYCRC = () => {
    return (
        <>
            <div><h2 className=" px-4 text-center mt-3">Roles of a CEMC</h2></div>
