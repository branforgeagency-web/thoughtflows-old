...
const CRCFAQ = () => {
    const faqContents =[
        {
            question: "Who is eligible to apply for CDEO training?",
            answer: "Anyone with significant experience in Evaluation and Management (E/M) coding is eligible to apply for CDEO (Certified Evaluation and Management Coder) training. This is particularly suitable for those wanting to demonstrate a high level of expertise in E/M coding by taking the CDEO certification exam. Typically, this requires at least two years of experience in medical coding, with a strong focus on E/M coding across different specialties."
        },
        {
            question: "What is the duration of the CDEO training program?",
            answer: "45 DAYS\nMONDAY TO FRIDAY\nONLINE"
        },
        {
        ...
        {
            question: "Is the CDEO training conducted online or offline?",
            answer: "Online: Interactive live sessions.\nOffline: In-person classes at our branches."
        },
        {
            question: "What is the format of the CDEO exam?",
        ...
        },
        {
            ...
            answer: "Chapter-wise assessments\nFull-length mock CDEO exams to help you prepare and track progress."
        },
        {
            question: "What is the pass rate for CDEO exams at Thoughtflows?",
