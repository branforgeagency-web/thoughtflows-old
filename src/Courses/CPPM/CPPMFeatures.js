    ...
    const courseSections =[
        {
            ...
            para: "Our live sessions provide a comprehensive and engaging learning environment. Each class includes:",
            points: [
                "PowerPoint Presentations to visualize key management concepts and industry guidelines.",
                "Video Tutorials that reinforce best practices in physician practice management.",
                "Interactive Q&A sessions to clarify doubts in real-time and ensure personalized attention."
            ]
        },
        {
            heading: "Practice Exams",
            para: "We offer a structured approach to mastering physician practice management through:",
            points: [
                "Chapter-wise Assessments designed to solidify your understanding of each module.",
                "Mock CPPM Exams that replicate the real exam environment, helping you build confidence and improve time management skills.",
                "Detailed Feedback on practice tests to identify strengths and areas for improvement.",
                "Progress Tracking to ensure you are on the path to CPPM certification success."
            ]
        },
        {
            ...
            points: [
                "Healthcare Compliance & Management Guides covering essential regulations and policies.",
                "Chapter-wise Study Plans to organize and streamline your preparation effectively."
            ]
        },
        {
            heading: "Interview Preparation",
            para: "We go beyond training to ensure you secure your first job confidently:",
            points: [
                "Resume Enhancement: Expert guidance on creating a compelling resume tailored to practice management roles.",
                ...
                "Placement Assistance to help you land positions offering competitive salary packages in medical practices and healthcare facilities."
            ]
        }
    ];
