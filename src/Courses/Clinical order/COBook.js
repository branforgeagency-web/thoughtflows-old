...
const features = [
    { icon: classroom, title: "ICD-10-CM Official Coding Guidelines", description: "For coding procedures and services." },
    { icon: studyMaterial, title: "CPT Professional Edition", description: "For accurate diagnosis coding." },
    { icon: learning, title: "HCPCS Level II Code Book", description: "For additional codes." },
    { icon: training, title: "Medical Terminology and Anatomy for Coding", description: "Provides detailed preparation for E/M coding." }
];
