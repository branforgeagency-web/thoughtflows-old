    ...
    const courseSections = [
        {
            ...
            points: [
                ...
                "Video Tutorials that reinforce coding skills and enhance understanding of emergency coding scenarios.",
                "Interactive Q&A sessions to clarify doubts in real-time and ensure personalized attention."
            ]
        },
        {
            heading: "Practice Exams",
            paragraph: "We offer a structured approach to mastering emergency department coding through:",
            points: [
                "Chapter-wise Assessments designed to solidify your understanding of each module.",
                "Mock CEDC Exams that replicate the real exam environment, helping you build confidence and improve time management skills.",
                "Detailed Feedback on practice tests to identify strengths and areas for improvement.",
                "Progress Tracking to ensure you are on the path to CEDC certification success."
            ]
        },
        {
            ...
            points: [
                "Code Books: Up-to-date editions of CPT, ICD-10-CM, and HCPCS Level II manuals for emergency department coding.",
        ...
        },
        {
            ...
            points: [
                "Resume Enhancement: Expert guidance on creating a compelling resume tailored to emergency department coding roles.",
                ...
                "Placement Assistance to help you land positions offering competitive salary packages in hospital emergency departments and urgent care centers."
            ]
        }
    ];
