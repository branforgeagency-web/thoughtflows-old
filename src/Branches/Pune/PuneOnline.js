...
const PuneOnline = () => {
  ...
  return (
    <div style={{ margin: "20px", marginTop: "50px", marginLeft: "40px", paddingBottom: "35px" }}>
      <h3 style={{ textAlign: "center", color: "#16ADBB" }}>Continuous Evaluation</h3>
      <h2 style={{ textAlign: "center", marginTop: "20px", marginBottom: "30px" }}>
        Online Mock Assessments & Speed Drills
      </h2>
      <Slider {...settings}>
        {images.map((img, index) => (
          <div key={index} style={{ position: "relative", overflow: "hidden" }}>
            <img
              src={img}
              alt={`Online Exam Session ${index + 1}`}
              style={{
                width: "90%",
                height: "auto",
                objectFit: "cover",
