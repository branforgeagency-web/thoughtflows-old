    ...
    <>
      ...
      >
        ...
        <Col lg={5} className="cbe1-banner-lft mb-4 mb-lg-0 order-1 order-lg-1">
          ...
          <Col className="cbe1-banner-heading">
            ...
            <h2 style={{ fontSize: "clamp(28px, 5vw, 40px)" }}>
              Institute in <span style={{ color: "#097D8A" }}>Tirupathi</span>
            </h2>
          </Col>
          <Col>
            <p style={{ fontSize: "16px", marginTop: "20px" }}>
              Discover excellence and seize opportunities with Thoughtflows Medical Coding Academy in Tirupathi.
            </p>
          </Col>
        ...
        <Col lg={5} className="cbe1-banner-rht text-center order-2 order-lg-2" >
          <img src={cbe1banner} alt='bannersmall' style={{ maxWidth: "100%", height: "auto", marginTop: "50px" ,marginBottom: "-70px"}} />
          {/* <video
            src={bannerVid}
