    ...
    <>
      <div className="get">
        <div className="get-1">
          ...
          <p>
            Our Trichy institute offers the most competitive fees in Tamil Nadu 
        ...
        <div className="get-2">
          <h2 style={{ marginBottom: "20px" }}>Visit Our Trichy Campus</h2>
          <p>
            Located in the heart of Trichy, our institute is easily accessible 
...
export default TrichyGetinTouch;
