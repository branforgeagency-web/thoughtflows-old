        ...
        <Col lg={3} md={4} xs={12} className='cbe1-banner-lft pt-5 px-4 mb-4 mb-lg-0 d-flex flex-column justify-content-lg-start justify-content-center align-items-lg-start align-items-center'>
          <Col className='cbe1-banner-heading'>
            <h1 style={{
              ...
              lineHeight: '1.2'
            }}>Medical Coding <br /> Institute in <span style={{ color: '#097D8A' }}>Trichy</span></h1>
          </Col>
          <Col>
            <p style={{
              ...
              marginTop: '20px',
              maxWidth: '600px'
            }}>Discover excellence and seize opportunities with Thoughtflows Medical Coding Academy in Trichy.</p>
          </Col>
          <Col className='cbe1-btn '>
