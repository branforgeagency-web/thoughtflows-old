...
const TrichyCore = () => {
    return (
        <div className="cbe1-features-container" style={{paddingTop:"50px"}}>
            <h2>Our Core Values</h2>
            <div className="features-grid">
                <div className="">
                    <h3 style={{color:"#073766",paddingTop:"50px"}}>Degree categories</h3>
                    <h2 >
                    Successfully Complete A Course at Thoughtflow Academy
                    </h2>
