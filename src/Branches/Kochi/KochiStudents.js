...
const KochiStudents = () => {
  ...
  return (
    <>
    <div style={{ margin: "20px", marginLeft: "40px", padding: "0px 0px" }} className="brand-tri">
    ...
    {/* <div style={{display:"flex" , justifyContent:"space-between",padding:"50px 0px"}}>
     <Marquee>

        <img src={client1}  style={{width:"200px"}}/>
        <img src={client2}   style={{width:"200px"}}/>
        <img src={client3}  style={{width:"200px"}} />
        <img src={client4} style={{background:"black", width:"200px"}}/>
        <img src={client5} style={{width:"200px"}} />
     </Marquee>
    </div> */}
    {/* <Companies/> */}
    </>
