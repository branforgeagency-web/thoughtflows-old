...
import navami from '../../images/Testimonials/Navami (Trivandrum).jpeg'
import anfiya from '../../images/Testimonials/Anfiya Navas (Trivandrum).jpeg'
import ayisha from '../../images/Testimonials/Ayisha nawf (Trivandrum).jpeg'
import dathan from '../../images/Testimonials/Dathan (Trivandrum).jpeg'
import gopika from '../../images/Testimonials/Gopika (Trivandrum).jpeg'
...
const testimonials = [
  {
    ...
    title: "Student",
    rating: 5,
    review: "I'm Navami.I completed medical coding from Thoughtflows medical coding academy and l recently cleared cpc with 90% mark in first attempt and was successfully placed in Cotiviti. I am extremely thankful to all the trainers and HR team especially Vaishna mam , Aleena mam,Anakha mam for their great support throughout my academic journey. Special thanks to placement team for their support. It was a great experience Thank you",
    avatar: `${navami}`
  },
  {
    image: `${anfiya}`,
  ...
  },
  {
    ...
    title: "Student",
    rating: 5,
    review: "I've had a wonderful experience at thought flow tvm . The faculty are knowledgable and supportive. I have particularly enjoyed my 3 month course which has helped me to achieve a job in my native place immediatly after the completion of course . I recently passed the CPC exam with 91%. I would like to thank Vaishna maam and Aleena maam for their great support . The atmospher is conducive to learning with a diverse and vibrant community of students and faculties. Thank you HR team for your encouragement and support.",
    avatar: `${gopika}`
  }
];

// TrivandrumTestimonial
const TrivandrumTestimonial = () => {
  return (
    <>
      <div
...
export default TrivandrumTestimonial;
