  ...
  return (
   ...
   <div className='enroll1-hyd'>
    ...
    <div className="enroll1-hyd-content">
        ...
        <p>
        Our Vizag institute stays at the forefront of medical coding education by 
        ...
        <h2 style={{marginTop:"50px",marginBottom:"25px"}}>Success Stories from Vizag Students</h2>
        <p>Our Vizag campus has produced hundreds of successful medical coders 
