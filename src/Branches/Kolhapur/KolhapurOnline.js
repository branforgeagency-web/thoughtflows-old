...
const KolhapurOnline = () => {
  ...
  return (
    <div style={{ margin: "20px", marginTop: "50px", marginLeft: "40px", paddingBottom: "35px" }}>
      <h3 style={{ textAlign: "center", color: "#16ADBB" }}>Test Your Knowledge</h3>
      <h2 style={{ textAlign: "center", marginTop: "20px", marginBottom: "30px" }}>
        Interactive Practice Tests & Mock Exams
      </h2>
      <Slider {...settings}>
