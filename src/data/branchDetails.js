export const branchDetails = {
  gandhipuram: {
    key: 'gandhipuram',
    name: 'Gandhipuram',
    displayName: 'Gandhipuram Branch',
  ...
  saravanampatti: {
    key: 'saravanampatti',
    name: 'Saravanampatti',
    displayName: 'Saravanampatti Branch',
    phone: '+91 93845 76852',
    phoneRaw: '9384576852',
    phoneClean: '+919384576852',
  ...
  dilsukhnagar: {
    key: 'dilsukhnagar',
    name: 'Dilsukhnagar',
    displayName: 'Dilsukhnagar Branch',
...
export const defaultBranchDetails = {
  key: 'head-office',
  name: 'Head Office',
...
/**
 * Returns branch details matching the given pathname, or null if pathname is not a branch page.
 * @param {string} pathname
 * @returns {object|null}
 */
export const getBranchInfoByPath = (pathname) => {
  if (!pathname) return null;
  const path = pathname.toLowerCase().trim();
  for (const branch of Object.values(branchDetails)) {
    if (branch.routes.some((r) => r.toLowerCase() === path)) {
      return branch;
    }
  }
  return null;
